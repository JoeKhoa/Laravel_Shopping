          ...
          <ul>
            ...
            @foreach ($sliders as $slider)
                ...
                <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700">
                  <!-- MAIN IMAGE -->
                  <img src="source/images/slider/{{$slider->image}}" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                  <!-- LAYERS -->
                  <!-- LAYER NR. 1 -->
                                  ...
                                  <div class="product-thumbnail">
                                    ...
                                    <div class="pr-img-area">
                                      <a title="Ipsums Dolors Untra" href="apple.store.vn/{{$prod->url}}.html">
                                        <figure>
                                          <img class="first-img" src="source/images/products-images/{{$prod->image}}" alt="html template">
                                          <img class="hover-img" src="source/images/products-images/{{$prod->image}}" alt="html template">
                                        </figure>
                                      </a>
                                      <button id ="{{$prod->id}}" type="button" class="add-to-cart-mt">
                  ...
                  <div class="top-sellers-pro">
                    <div class="slider-items-products">
                      <div id="top-sellers-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4 ">
                          @foreach ($BestSellProducts as $prod)
