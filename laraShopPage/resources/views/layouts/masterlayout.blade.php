                    ...
                    <a  class ="cart-logo" href="apple.store.vn/cart.html">
                      ...
                      <div class="shoppingcart-inner hidden-xs">
                        ...
                        <span class="cart-total">
                          <b class="cart-totalQty">{{$totalQty}} </b> Item(s),
                          <b class="cart-totalPrice">{{ number_format($totalPromtPrice,0,',','.')}}₫ </b>
                ...
                <div class="mega-menu-category">
                  <ul class="nav">
                    ...
                    @foreach ($categories as $item)
                      ...
                      <li cate-id='{{$item->id}}'>
                          <a href="apple.store.vn/{{$item->url}}">
                          <i class='icon fa {{isset($item->icon)? $item->icon:'fa-inbox'}} fa-fw'></i> {{$item->name}}</a>
